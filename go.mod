...
require (
	...
	github.com/openshift-online/gecko/platform-api v0.0.0-20260825001645-d528664f4af9
...
require (
	...
	github.com/openshift-online/gecko/orlop v0.0.0-20260825001645-d528664f4af9 // indirect
